...
<div align="center">
  <img src="https://via.placeholder.com/800x500/E8F4FD/4A90E2?text=Calendar+View+-+Main+Dashboard" alt="Calendar View Dashboard" width="800"/>
  <p><em>Calendar View - Interactive scheduling with drag-and-drop functionality</em></p>
</div>

<div align="center">
  <img src="https://via.placeholder.com/400x300/FFF2E8/FF8C00?text=Spreadsheet+View" alt="Spreadsheet View" width="400"/>
  <img src="https://via.placeholder.com/400x300/E8F5E8/4CAF50?text=Staff+Management" alt="Staff Management" width="400"/>
...
<div align="center">
  <img src="https://via.placeholder.com/300x600/F3E5F5/9C27B0?text=Mobile+Responsive" alt="Mobile View" width="300"/>
  <p><em>Mobile Responsive Design</em></p>
</div>

<div align="center">
  <img src="https://via.placeholder.com/600x400/E1F5FE/00BCD4?text=AI+Assistant+Interface" alt="AI Assistant" width="600"/>
...
[![Demo Video](https://via.placeholder.com/800x450/FF6B6B/FFFFFF?text=🎥+Demo+Video+Coming+Soon)](https://roster.chanmeng.org/)
...
<div align="center">
 ...
 <img src="https://img.shields.io/badge/next.js-14.2.5-000000.svg?style=for-the-badge&logo=nextdotjs&logoColor=white"/>
 <img src="https://img.shields.io/badge/react-18-20232a.svg?style=for-the-badge&logo=react&logoColor=61DAFB"/>
 <img src="https://img.shields.io/badge/typescript-5-007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white"/>
 <img src="https://img.shields.io/badge/copilotkit-1.8.12-06F9C0.svg?style=for-the-badge&logo=openai&logoColor=white"/>
 <img src="https://img.shields.io/badge/tailwindcss-3.4.1-38B2AC.svg?style=for-the-badge&logo=tailwindcss&logoColor=white"/>
 <img src="https://img.shields.io/badge/toast%20ui-2.1.3-FF6B6B.svg?style=for-the-badge&logo=calendar&logoColor=white"/>
 <img src="https://img.shields.io/badge/langchain-0.3.18-FF6B6B.svg?style=for-the-badge&logo=chainlink&logoColor=white"/>
...
<details>
  ...
  <picture>
    ...
    <img width="100%" src="https://api.star-history.com/svg?repos=ChanMeng666%2Fhospital-roster-agent&type=Date">
  </picture>
</details>
...
<div align="center">
  <img src="https://via.placeholder.com/600x400/E8F4FD/4A90E2?text=Calendar+Interface+Demo" alt="Calendar Feature Demo" width="600"/>
...
<div align="center">
  <img src="https://via.placeholder.com/300x400/E8F5E8/4CAF50?text=AI+Chat+Interface" alt="AI Assistant Mode A" width="300"/>
  <img src="https://via.placeholder.com/300x400/FFF2E8/FF8C00?text=Voice+Commands" alt="AI Assistant Mode B" width="300"/>
...
<div align="center">
  <table>
    <tr>
      ...
      <td align="center" width="96">
        <img src="https://cdn.simpleicons.org/openai" width="48" height="48" alt="CopilotKit" />
      ...
      <td align="center" width="96">
        <img src="https://cdn.simpleicons.org/javascript" width="48" height="48" alt="TOAST UI" />
        <br>TOAST UI 2.1.3
      </td>
    </tr>
  </table>
...
graph TB
    subgraph "Frontend Layer"
        ...
        B --> C[Calendar View]
        B --> D[Spreadsheet View]
        B --> E[Staff Management]
        C --> F[TOAST UI Calendar]
        D --> G[React Spreadsheet]
    end
    
    subgraph "AI Layer"
        H[CopilotKit Runtime] --> I[LangChain Core]
        I --> J[OpenAI API]
        I --> K[LangGraph Workflows]
        H --> L[AI Actions]
    end
    
    subgraph "State Management"
        M[React State] --> N[Local Storage]
...
graph LR
    ...
    subgraph "Frontend"
        F1[Next.js 14]
        F2[React 18]
        F3[TOAST UI Calendar]
        F4[React Spreadsheet]
    end
...
sequenceDiagram
    ...
    participant C as Calendar/Spreadsheet
    participant A as AI Assistant
    participant S as State Management
    participant AI as OpenAI API
    participant L as Local Storage
    
    U->>C: User Action (Create/Edit Shift)
    C->>S: Update State
    S->>L: Persist Data
    
    U->>A: Natural Language Command
    A->>AI: Process Command
    AI->>A: AI Response
    A->>S: Execute Action
    S->>C: Update UI
    S->>L: Persist Changes
...
<div align="center">
  <img src="https://via.placeholder.com/800x500/F5F5F5/333333?text=Component+Architecture+Diagram" alt="Component Architecture" width="800"/>
...
<div align="center">
  <img src="https://via.placeholder.com/800x300/E8F4FD/4A90E2?text=Performance+Dashboard" alt="Performance Dashboard" width="800"/>
...
|                   Desktop                   |                   Mobile                   |
| :-----------------------------------------: | :----------------------------------------: |
|              <img src="https://via.placeholder.com/400x300/4CAF50/FFFFFF?text=Desktop+95%2B" alt="Desktop Performance" width="400"/>              |              <img src="https://via.placeholder.com/400x300/FF9800/FFFFFF?text=Mobile+90%2B" alt="Mobile Performance" width="400"/>              |
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FChanMeng666%2Fhospital-roster-agent)
...
<div align="center">
  <img src="https://via.placeholder.com/600x400/E8F4FD/4A90E2?text=Calendar+Operations+Guide" alt="Calendar Operations" width="600"/>
...
<div align="center">
  <img src="https://via.placeholder.com/600x400/FFF2E8/FF8C00?text=Spreadsheet+Management" alt="Spreadsheet Management" width="600"/>
...
```mermaid
flowchart TD
    A[Create Feature Branch] --> B[Develop Components]
    B --> C[Add AI Actions]
    C --> D[Update Types]
...
<a href="https://github.com/ChanMeng666/hospital-roster-agent/graphs/contributors" target="_blank">
  <table>
    <tr>
      <th colspan="2">
        <br><img src="https://contrib.rocks/image?repo=ChanMeng666/hospital-roster-agent"><br><br>
      </th>
    </tr>
  </table>
</a>
...
<a href="https://github.com/sponsors/ChanMeng666" target="_blank">
  <picture>
    ...
    <img src="https://via.placeholder.com/600x200/4A90E2/FFFFFF?text=❤️+Sponsor+Hospital+Roster+Agent">
  </picture>
</a>
...
<img src="https://img.shields.io/github/stars/ChanMeng666/hospital-roster-agent?style=social" alt="GitHub stars">
<img src="https://img.shields.io/github/forks/ChanMeng666/hospital-roster-agent?style=social" alt="GitHub forks">
<img src="https://img.shields.io/github/watchers/ChanMeng666/hospital-roster-agent?style=social" alt="GitHub watchers">
